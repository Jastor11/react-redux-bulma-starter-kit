        ...
        <nav className="nav has-shadow" id="top">
          <div className="container">
            ...
            <div className="nav-right nav-menu">
              ...
              <a className="nav-item is-tab">
                <img src="https://placehold.it/64x64" className="avatar-photo" />
              </a>
            </div>
          </div>
        </nav>
                      ...
                      <div className="columns">
                        <div className="column is-6">
                          <p>
                            ...
                            <br />
                            <a href="#" className="button is-danger">Subscribe</a>
                          </p>
                        </div>
                        <div className="column is-6">
                          <nav className="nav">
                      ...
                      <nav className="level">
                        <p className="level-item has-text-left">
                          <a className="button is-default">
                            <span className="icon"><i className="fa fa-plus"></i></span> <span>Add to</span>
                          </a>
                          <a className="button is-default">
                            <span className="icon"><i className="fa fa-share"></i></span> <span>Share</span>
                          </a>
                          <a className="button is-default">
                            <span className="icon"><i className="fa fa-ellipsis-h"></i></span> <span>More</span>
                          </a>
                        </p>
                        <p className="level-item has-text-right">
                          <a className="button is-default"><i className="fa fa-thumbs-up"></i> 5254</a>
                          <a className="button is-default"><i className="fa fa-thumbs-down"></i> 1</a>
                        </p>
                      </nav>
                    </div>
                  </div>
